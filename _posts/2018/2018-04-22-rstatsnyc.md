...
<iframe src="//www.slideshare.net/slideshow/embed_code/key/67s7If0jpkCCo3" width="595" height="485" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> </iframe> <div style="margin-bottom:5px"> <strong> <a href="//www.slideshare.net/wesm/apache-arrow-crosslanguage-development-platform-for-inmemory-data" title="Apache Arrow -- Cross-language development platform for in-memory data" target="_blank">Apache Arrow -- Cross-language development platform for in-memory data</a> </strong> from <strong><a href="https://www.slideshare.net/wesm" target="_blank">Wes McKinney</a></strong> </div>
